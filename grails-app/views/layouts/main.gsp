...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"><!--<![endif]-->
	<head>
		...
		<title><g:layoutTitle default="Vermont State Legislature"/></title>
...
<!-- 		<div id="grailsLogo" role="banner"><a href="http://www.leg.state.vt.us/"><img src="http://www.leg.state.vt.us/Common/Images/LegislatureHome.jpg" alt="Vermont State Legislature"/></a></div>
 -->
		...
		Welcome<span id:"userFirstName"></span> ${session?.user?.firstName }!
		</span><br><br>
		Your last login was xx/xxx/xxxx<br>
		</div>
		</g:if>
		<g:else>
		   ...
		   <g:renderErrors bean="${loginCmd}"></g:renderErrors>
			...
			<g:else>
				<div id="registerPane">
					...
					to have access to advanced features.
				</div>						
			</g:else>
		</div>
